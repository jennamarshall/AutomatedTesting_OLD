...
def find_visible_element(how, what)
  ...
  def test_login_to_Response_by_hour_of_day
	...
	@driver.find_element(:xpath, "(//input[@type='text'])[4]").send_keys "Average Response Time by Hour of Day -automation"
	...
	wait_for { displayed?(:xpath, "//div[text() = 'Average Response Time by Hour of Day -automation']") }
	@driver.find_element(:xpath, "//div[text() = 'Average Response Time by Hour of Day -automation']").click	
