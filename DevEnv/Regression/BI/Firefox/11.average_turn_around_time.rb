...
class LoginToTurnAround< Test::Unit::TestCase
...
def find_visible_element(how, what)
  ...
  def test_login_to_Turn_Around
	...
	@driver.find_element(:xpath, "(//input[@type='text'])[4]").send_keys "Average Turn Around Time -automation"
    ...
    wait_for { displayed?(:xpath, "//div[text() = 'Average Turn Around Time -automation']") }
	@driver.find_element(:xpath, "//div[text() = 'Average Turn Around Time -automation']").click	
