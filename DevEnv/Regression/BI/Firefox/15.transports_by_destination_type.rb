...
class LoginToTransportsByDestinationType< Test::Unit::TestCase
...
def find_visible_element(how, what)
  ...
  def test_LoginToTransportsByDestinationType
    @driver.get(@base_url)
	...
	@driver.find_element(:xpath, "(//input[@type='text'])[4]").send_keys "Transports by Destination Type -automation ff"
    ...
    wait_for { displayed?(:xpath, "//div[text() = 'Transports by Destination Type -automation ff']") }
	@driver.find_element(:xpath, "//div[text() = 'Transports by Destination Type -automation ff']").click	
