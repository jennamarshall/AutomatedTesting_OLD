...
sendEmail -f esoanalyticsqa@gmail.com -t jenna.wakeley@esosolutions.com -s smtp.gmail.com:587 -xu esoanalyticsqa@gmail.com -xp .admin77.  -u "Results:  Daily Analytics Operational Tests Regression" -m "Howdy Partner, attached are the results of the Daily Analytics Smoke Tests.  These tests were executed in the latest version of Firefox against the HotFix Environment on DevDb5" -o tls=yes -a "C:\Analytics\AutomatedTesting\DevEnv\Regression\BI\Firefox\regression_log.txt" 
