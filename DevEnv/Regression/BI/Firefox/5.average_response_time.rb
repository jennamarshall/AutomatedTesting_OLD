...
def find_visible_element(how, what)
  ...
  def test_login_to_response
	...
	@driver.find_element(:xpath, "(//input[@type='text'])[4]").send_keys "Average Response Time -automation"
    ...
    wait_for { displayed?(:xpath, "//div[text() = 'Average Response Time -automation']") }
	@driver.find_element(:xpath, "//div[text() = 'Average Response Time -automation']").click	
