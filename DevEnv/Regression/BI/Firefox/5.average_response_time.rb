...
class LoginToResponse< Test::Unit::TestCase
...
def find_visible_element(how, what)
  ...
  def test_login_to_Response
	...
	@driver.find_element(:xpath, "(//input[@type='text'])[4]").send_keys "Average Response Time -automation ff"
    ...
    wait_for { displayed?(:xpath, "//div[text() = 'Average Response Time -automation ff']") }
	@driver.find_element(:xpath, "//div[text() = 'Average Response Time -automation ff']").click	
