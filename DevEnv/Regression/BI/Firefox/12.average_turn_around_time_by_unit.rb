...
class LoginToTurnAroundByUnit< Test::Unit::TestCase
...
def find_visible_element(how, what)
  ...
  def test_login_to_Turn_Around_by_unit
    @driver.get(@base_url)
	...
	@driver.find_element(:xpath, "(//input[@type='text'])[4]").send_keys "Average Turn Around Time By Unit -automation ff"
	...
	sleep (2)
	wait_for { displayed?(:xpath, "//div[text() = 'Average Turn Around Time By Unit -automation ff']") }
	@driver.find_element(:xpath, "//div[text() = 'Average Turn Around Time By Unit -automation ff']").click	
