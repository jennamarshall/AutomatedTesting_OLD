...
class LoginToTurnAroundByHourOfDay< Test::Unit::TestCase
...
def find_visible_element(how, what)
  ...
  def test_login_to_TurnAround_by_hour_of_day
    @driver.get(@base_url)
	...
	wait_for { displayed?(:xpath, "//div[text() = '79%']") }
	wait_for { displayed?(:xpath, "//div[text() = '365']") }
	wait_for { displayed?(:xpath, "//div[text() = '3,134']") }
	...
	wait_for { displayed?(:xpath, "//div[text() = '12:49']") }
	wait_for { displayed?(:xpath, "//div[text() = '86%']") }
	wait_for { displayed?(:xpath, "//div[text() = '365']") }
	wait_for { displayed?(:xpath, "//div[text() = '809']") }
	
	@driver.find_element(:xpath, "//td[17]").click
	...
	@driver.find_element(:xpath, "(//input[@type='text'])[4]").send_keys "Average Turn Around Time by Hour of Day -automation"
	...
	wait_for { displayed?(:xpath, "//div[text() = 'Average Turn Around Time by Hour of Day -automation']") }
	@driver.find_element(:xpath, "//div[text() = 'Average Turn Around Time by Hour of Day -automation']").click	
	...
	wait_for { displayed?(:xpath, "//td[17]") }
	@driver.find_element(:xpath, "//td[17]").click
	...
	wait_for { displayed?(:xpath, "//div[text() = '12:49']") }
	wait_for { displayed?(:xpath, "//div[text() = '87%']") }
	wait_for { displayed?(:xpath, "//div[text() = '365']") }
	wait_for { displayed?(:xpath, "//div[text() = '809']") }
