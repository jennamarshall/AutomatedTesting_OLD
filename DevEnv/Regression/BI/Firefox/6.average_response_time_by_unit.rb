...
def find_visible_element(how, what)
  ...
  def test_login_to_Response_by_unit
	...
	@driver.find_element(:xpath, "(//input[@type='text'])[4]").send_keys "Average Response Time By Unit -automation ff"
	...
	sleep (2)
	wait_for { displayed?(:xpath, "//div[text() = 'Average Response Time By Unit -automation ff']") }
	@driver.find_element(:xpath, "//div[text() = 'Average Response Time By Unit -automation ff']").click	
