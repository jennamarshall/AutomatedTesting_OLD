...
def find_visible_element(how, what)
  ...
  def test_LoginToTransportsByDestinationType
	...
	@driver.find_element(:xpath, "(//input[@type='text'])[4]").send_keys "Transports by Destination Type -automation"
    ...
    wait_for { displayed?(:xpath, "//div[text() = 'Transports by Destination Type -automation']") }
	@driver.find_element(:xpath, "//div[text() = 'Transports by Destination Type -automation']").click	
