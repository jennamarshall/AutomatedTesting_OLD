...
def find_visible_element(how, what)
  ...
  def test_login_to_Turn_Around_by_unit
	...
	@driver.find_element(:xpath, "(//input[@type='text'])[4]").send_keys "Average Turn Around Time By Unit -automation"
	...
	sleep (2)
	wait_for { displayed?(:xpath, "//div[text() = 'Average Turn Around Time By Unit -automation']") }
	@driver.find_element(:xpath, "//div[text() = 'Average Turn Around Time By Unit -automation']").click	
