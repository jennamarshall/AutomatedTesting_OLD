...
class LoginToResponseHodDT< Test::Unit::TestCase
...
def setup
  ...
  def test_login_to_response_hod_dt
    @driver.get(@base_url)
...
@driver.find_element(:xpath, "//div[@id='detail-root']/div[3]/div/div").click
    sleep (2)
@driver.find_element(:xpath, "//div[@id='content']/div[2]/div/table/tbody/tr[8]/td[2]").click
    sleep (2)
@driver.find_element(:xpath, "//div[@id='detail-root']/div[3]/div/div").click
    sleep (2)
